...
#ifndef __ESTIMATION_UTILS_UTILS__
#define __ESTIMATION_UTILS_UTILS__

#include <memory>

namespace estimation_utils { namespace utils {
...
public:
    ...
    typedef std::unique_ptr<FilterWrap<SignalType>> UniquePtr;
...
#endif // __ESTIMATION_UTILS_UTILS__
